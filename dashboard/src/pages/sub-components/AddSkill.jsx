      ...
      <div className="flex justify-center items-center min-h-[100vh] sm:gap-4 sm:py-4 sm:pl-14">
        <form className="w-[100%] px-5 md:w-[650px]" onSubmit={handleAddNewSkill}>
          <div className="space-y-12 ">
            <div className="border-b border-gray-900/10 pb-12">
              ...
              <div className="mt-10 flex flex-col gap-5">
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md  shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      <Input type="number" placeholder="30" value = {proficiency} onChange={(e) => setProficiency(e.target.value)} className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-2"/>
                    </div>
                  </div>
                </div>
                ...
                <div className= "col-span-full">
                  ...
                  <div className= "mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                    <div className= "text-center">
                      {
                        svgPreview ? (<img className='mx-auto h-[250px] w-[250px] rounded-md text-gray-300'  src = { svgPreview ? `${svgPreview}`: `./avatarHolder.jpeg1` } alt="svg"/>) : (<Image className='mx-auto h-12 w-12 text-gray-300' aria-hidden='true'/>)
                      }
            ...
            {
              loading ? <SpecialLoadingButton content={"Adding Skill..."}/> : <Button type="submit" className="w-full">Add Skill...</Button>
            }
          </div>
        </form>
      </div>
