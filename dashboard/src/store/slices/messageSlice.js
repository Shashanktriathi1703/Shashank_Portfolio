...
export const getAllMessages = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get("https://shashank-portfolio-6o8s.onrender.com/api/v1/message/getall",{ withCredentials: true });
...
export const deleteMessage = (id) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.delete(`https://shashank-portfolio-6o8s.onrender.com/api/v1/message/delete/${id}`, {withCredentials: true});
