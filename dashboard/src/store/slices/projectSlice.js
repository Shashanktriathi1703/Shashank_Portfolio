...
export const getAllProjects = () => async(dispatch) => {
    ...
    try{
        const { data } = await axios.get("https://shashank-portfolio-6o8s.onrender.com/api/v1/project/getall", { withCredentials: true });
...
export const addNewProject = (data) => async(dispatch) => {
    ...
    try {
        const response = await axios.post("https://shashank-portfolio-6o8s.onrender.com/api/v1/project/add", data, {withCredentials: true, headers:{"Content-Type":"multipart/form-data"}});//const {data} => de-structure kr rahe (ek aur cheez "application/json" isko tab use karte jab hamare form mai koi image na hoti to) 
...
export const updateProject = (id, projectdata) => async(dispatch) => {
    ...
    try{
        const { data } = await axios.put(`https://shashank-portfolio-6o8s.onrender.com/api/v1/project/update/${id}`, projectdata, {withCredentials: true, headers:{"Content-Type": "multipart/form-data"}});
...
export const deleteProject = (id) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.delete(`https://shashank-portfolio-6o8s.onrender.com/api/v1/project/delete/${id}`, {withCredentials: true});
