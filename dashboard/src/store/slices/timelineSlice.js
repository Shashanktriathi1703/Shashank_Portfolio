...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get("https://shashank-portfolio-6o8s.onrender.com/api/v1/timeline/getall",{ withCredentials: true });
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.delete(`https://shashank-portfolio-6o8s.onrender.com/api/v1/timeline/delete/${id}`, {withCredentials: true});
...
export const addNewTimeline = (timelineData) => async(dispatch) => {
    ...
    try {
        const { data } = await axios.post(`https://shashank-portfolio-6o8s.onrender.com/api/v1/timeline/add`, timelineData, { withCredentials: true, headers: { "Content-Type" : "application/json" } });
