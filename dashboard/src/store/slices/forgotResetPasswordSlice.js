...
export const resetPassword = (token, password, confirmPassword) => async(dispatch) => {
    ...
    try {
      const {data} = await axios.put(`http://localhost:4000/api/v1/user/password/reset/${token}`, { password, confirmPassword }, {withCredentials: true, headers: {"Content-Type": "application/json"}});
