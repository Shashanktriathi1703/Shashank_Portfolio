...
export const getAllSkills = () => async(dispatch) => {
  ...
  try {
    const { data } = await axios.get("https://shashank-portfolio-6o8s.onrender.com/api/v1/skill/getall",{ withCredentials: true });
...
export const addNewSkill = (data) => async(dispatch) => {
    ...
    try {
        const response = await axios.post("https://shashank-portfolio-6o8s.onrender.com/api/v1/skill/add", data, {withCredentials: true, headers:{"Content-Type":"multipart/form-data"}});//const {data} => de-structure kr rahe
...
export const deleteSkill = (id) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.delete(`https://shashank-portfolio-6o8s.onrender.com/api/v1/skill/delete/${id}`, {withCredentials: true});
...
export const updateSkill = (id, proficiency) => async(dispatch) =>{
    ...
    try{
        const { data } = await axios.put(`https://shashank-portfolio-6o8s.onrender.com/api/v1/skill/update/${id}`, {proficiency}, {withCredentials: true, headers:{"Content-Type":"application/json"}});
